      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between border-b border-border pb-4">
          <div className="space-y-1">
            ...
            <p className="text-xs font-semibold text-muted-foreground">AI-generated content ideas with search intent, priority, and expected GEO impact.</p>
          </div>
        </div>
        <BrandScanner 
          title="Generate Content Strategy" 
          description="Enter your product details to generate conversational content ideas tailored to boost AI recommendation." 
        />
      </div>
    );
  }
